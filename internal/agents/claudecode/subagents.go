...
tools: mcp__gortex__smart_context, mcp__gortex__surface_memories, mcp__gortex__search_symbols, mcp__gortex__get_symbol_source, mcp__gortex__get_editing_context, mcp__gortex__get_file_summary, mcp__gortex__find_usages, mcp__gortex__get_callers, mcp__gortex__get_call_chain, mcp__gortex__get_dependencies, mcp__gortex__get_dependents, mcp__gortex__get_repo_outline, mcp__gortex__graph_stats, mcp__gortex__get_symbol, mcp__gortex__read_file
---
...
3. For "where is X" — ` + "`search_symbols`" + ` then ` + "`get_symbol_source`" + `.
...
6. For architecture / "how does the system fit together" — ` + "`get_repo_outline`" + ` then drill into the named communities with ` + "`smart_context`" + `.
