...
func TestCypher_NodeShape(t *testing.T) {
	...
	// Header.
	assert.Contains(t, out, "// Auto-generated by gortex export")
	assert.Contains(t, out, "CREATE INDEX gortex_node_id")
}
...
func TestCypher_EmptyGraph(t *testing.T) {
	...
	// Header + index statement should still appear so the file is still
	// loadable even when empty.
	assert.Contains(t, buf.String(), "CREATE INDEX gortex_node_id")
	assert.NotContains(t, buf.String(), "CREATE (:")
}
